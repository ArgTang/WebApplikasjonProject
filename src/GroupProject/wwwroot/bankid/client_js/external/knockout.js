...
(function(){
    ...
    (function(undefined){
        ...
        var window = this, // || (0, eval)('this'), // BID-8753 - no eval in the client!
            document = window['document'],
            navigator = window['navigator'],
            jQuery = undefined, // window["jQuery"],
            JSON = window["JSON"];
        (function(factory) {
            ...
            (function () {
                ...
                function jQueryHtmlParse(html, documentContext) {
                    ...
                    if (jQuery['parseHTML']) {
                        ...
                        var elems = jQuery['clean']([html], documentContext);
                ...
                ko.utils.parseHtmlFragment = function(html, documentContext) {
                    return jQuery ? jQueryHtmlParse(html, documentContext)   // As below, benefit from jQuery's optimisations where possible
...
// inheritance chain is created manually in the ko.dependentObservable constructor
            ...
            ko.expressionRewriting = (function () {
                ...
                // as a regular expression (this is handled by the parsing loop below).
                    stringRegexp = '/(?:[^/\\\\]|\\\\.)*/w*', // XXX edited by aor - original literal: '/(?:[^/\\\\]|\\\\.)*/\w*'
                // These characters have special meaning to the parser and must not appear in the middle of a
                // token, except as part of a string.
                    specials = ",\"'{}()/:[\\]", // XXX changed from '' to "".
